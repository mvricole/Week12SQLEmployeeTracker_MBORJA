...
// This function determines what appears when application launches. In this situation, you will see the prompts at initiation.
// From there, the user can engage with the database.
function init() {
  loadMainPrompts();
}
